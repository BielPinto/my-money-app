...
import Select2 from '../common/form/selects'
        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <If test={this.props.showStatus}>
                    <td>
                        <Field name={`${this.props.field}[${index}].status`}  className='form-control' type="select" component="select"  
                     value={this.props.list[index].status}>
